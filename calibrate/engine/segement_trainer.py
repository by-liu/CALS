...
class SegmentTrainer(Trainer):
    ...
    def log_iter_info(self, iter, max_iter, epoch, phase="train"):
        ...
        log_dict.update(self.segment_evaluator.curr_score())
    ...
    def log_epoch_info(self, epoch, phase="train"):
        log_dict = {}
        log_dict["samples"] = self.segment_evaluator.num_samples()
        ...
        metric = self.segment_evaluator.mean_score()
    ...
    def log_eval_epoch_info(self, epoch, phase="val"):
        ...
        class_table_data = self.segment_evaluator.class_score()
        if phase.lower() == "test":
